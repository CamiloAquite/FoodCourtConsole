...
namespace preAplicacion.Vistas.VistasModelos
{
    public class PropietarioVM
    {
        ...
        public PropietarioVM(int idPropietario, string nombrePropietario, int edadPropietario, string telefonoPropietario,
                            string correoPropietario, string cargoPropietario, string nombreRestaurantePropietario, List<Empleado> empleado)
        {
